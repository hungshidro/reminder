...
import {checkDayTime, timeToString, timeToTimeString} from 'utils/common/time';

export const ItemFlaged = ({
  item,
  onDetailPressed,
  onFlagPressed,
  onDeletePressed,
  ...
  const [isCompleted, setCompleted] = useState(
    new Date().getTime() > item?.dateTime && item.dateTime != 0,
  );
